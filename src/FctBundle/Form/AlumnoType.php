...
class AlumnoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('nombreAlu', TextType::class, array("required"=>false,
                "attr"=>["class"=>"form-name form-control"], "label" => "Nombre:"))
            ->add('apellido1Alu', TextType::class, array( "required"=>false,
                "attr"=>["class"=>"form-surname1 form-control"], "label" => "Primer apellido:"))
            ->add('apellido2Alu', TextType::class, array("required"=>false,
                "attr"=>["class"=>"form-surname2 form-control"], "label" => "Segundo apellido:"))
            ->add('fotografiaAlu', FileType::class,  array(
                "required"=>false, 
            ...
            ->add('direccionAlu', TextType::class, array("required"=>false,
                "attr"=>["class"=>"form-address form-control"], "label" => "Direccion:"))
            ->add('poblacionAlu', TextType::class, array("required"=>false,
                "attr"=>["class"=>"form-poblation form-control"], "label" => "Poblacion:"))
            ->add('cpostalAlu', TextType::class, array("required"=>false,
                "attr"=>["class"=>"form-cp form-control"], "label" => "Codigo Postal:"))
            ->add('telfFijoAlu', TextType::class, array("required"=>false,
                "attr"=>["class"=>"form-nif form-control"], "label" => "Nº de Telefono Fijo:"))
            ->add('telfMovilAlu', TextType::class, array("required"=>false,
